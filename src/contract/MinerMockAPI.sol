...
contract MinerMockAPI {
    ...
    /* address input parameter has to be in string because we need "t0...." (SP's address)
    to be the owner not the address field which will be in 0x format */
    function bytesOwner(string memory _address) public {
